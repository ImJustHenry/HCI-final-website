...
*/
  ...
  var Zqb = function (a) {
    ...
    frb = function (a, b, c) {
      var d = typeof c;
      "object" === d || "function" === d ? (a[b] = c) : crb(a, b, c);
    },
    grb = function () {
      var a = new arb();
      a.__default = frb;
    ...
    e5 = function (a, b) {
      ...
      b = krb(a, c, 1 === a.nodeType ? d || b : null);
    ...
    lrb = function (a, b, c, d, e) {
      return b == c && d == e;
    },
    i5 = function (a) {
      for (var b = f5, c = g5(); c !== a; ) {
        var d = c.nextSibling;
        b.removeChild(c);
        h5.j.push(c);
        c = d;
    ...
    g5 = function () {
      return j5 ? j5.nextSibling : f5.firstChild;
    },
    mrb = function (a, b) {
      j5 = g5();
      var c;
      ...
      c ||
        ("#text" === a
          ? ((a = l5.createTextNode("")), krb(a, "#text", null))
          : ((c = l5),
            (d = f5),
            "function" === typeof a
              ? (c = new a())
      ...
      if (a !== j5) {
        if (0 <= m5.indexOf(a))
          for (b = f5, c = a.nextSibling, d = j5; null !== d && d !== a; )
            (e = d.nextSibling), b.insertBefore(d, c), (d = e);
        else f5.insertBefore(a, j5);
        j5 = a;
      }
    },
    nrb = function (a, b) {
    ...
    prb = function (a, b) {
      b = void 0 === b ? {} : b;
      var c = void 0 === b.matches ? lrb : b.matches;
      return function (d, e, f) {
        ...
        n5 = [];
        j5 = null;
        var t = (f5 = d.parentNode),
          v,
          w = orb.call(d);
        if (
          (v =
            11 === w.nodeType || 9 === w.nodeType ? w.activeElement : null) &&
          d.contains(v)
        ) {
          for (w = []; v !== t; )
            w.push(v), (v = v.parentNode || (t ? v.host : null));
          t = w;
        } else t = [];
        m5 = t;
        try {
    ...
    yrb = function (a, b) {
      s5(b);
      if (a && void 0 !== a.wk && void 0 !== a.zr && void 0 !== a.jB) {
        if (wrb(a)) for (b = a.gQ; b < a.wk.length; b++) xrb(a.wk[b], a.zr[b]);
        for (; a.wk.length > a.gQ; ) a.wk.pop(), a.jB.pop(), a.zr.pop();
      }
    },
    zrb = function (a) {
      u5(a);
      for (var b = 0; b < a.wk.length; b++) {
        ...
        if (!wrb(c) || c.Yl)
          if (c.Yl || 1 !== c.AY)
            (c.E_(c) || zrb(c)) && c.F_(c), (c.Yl = !1), (c.AY = 1);
        if (d !== c.version) return !0;
      }
      return !1;
    },
    xrb = function (a, b) {
      ...
      u5(a);
      if (1 === a.bk.length)
        for (var c = 0; c < a.wk.length; c++) xrb(a.wk[c], a.zr[c]);
      c = a.bk.length - 1;
      a.bk[b] = a.bk[c];
      a.Fw[b] = a.Fw[c];
      a.bk.length--;
      a.Fw.length--;
      b < a.bk.length && ((c = a.Fw[b]), (a = a.bk[b]), u5(a), (a.zr[c] = b));
    },
    wrb = function (a) {
      var b, c;
      return (
        ...
        0 <
          (null !=
          (c = null == a ? void 0 : null == (b = a.bk) ? void 0 : b.length)
            ? c
            : 0)
      );
    },
    ...
    Drb = function (a, b, c) {
      ...
      e.pB =
        ...
        (a.destroy = function () {
          if (null !== e.Ms || null !== e.schedule) {
            u5(e);
            if (wrb(e))
              for (var f = 0; f < e.wk.length; f++) xrb(e.wk[f], e.zr[f]);
            e.wk.length = e.jB.length = e.zr.length = 0;
            e.bk && (e.bk.length = e.Fw.length = 0);
            e.Zy();
            e.Ms = null;
            e.schedule = null;
            e.Zy = Brb;
    ...
    Brb = function () {},
    Erb = function (a) {
      return Object.create(Object.assign({}, v5, { BN: a }));
    },
    w5 = function (a, b) {
      a = s5(a);
      try {
    ...
    Hrb = function (a) {
      var b = q5;
      b && !b.isDisposed && (b.qF || (b.qF = []), b.qF.push(a));
    },
    Jrb = function (a) {
      var b;
      null == (b = a.qF) || b.forEach(Grb);
      a.qF && (a.qF = []);
      a.eD &&
        (w5(Irb, function () {
          for (var c = g.u(a.eD), d = c.next(); !d.done; d = c.next())
            (d = d.value), d();
        }),
        (a.eD = []));
    },
    ...
    Orb = function (a, b) {
      if (!a.C && b) {
        ...
        try {
          ...
          var c, d;
          null == (d = C5.Nz) ||
            d.call(C5, null == (c = a.j) ? void 0 : c.Vu, e);
        }
        D5.TH(a);
        a.el = null;
    ...
    Prb = function (a) {
      if (a) {
        ...
        a.__instance &&
          ((b = a.__instance), Orb(b, a), b instanceof B5 && b.G());
        for (b = 0; b < a.childNodes.length; b++) Prb(a.childNodes[b]);
      }
    },
    Rrb = function (a) {
      1 === Qrb.push(a) &&
        requestAnimationFrame(function () {
          setTimeout(function () {
            var b = [].concat(g.qa(Qrb));
            Qrb = [];
            b = g.u(b);
            for (var c = b.next(); !c.done; c = b.next()) {
              c = c.value;
              try {
                for (var d = 0; d < c.length; d++) Prb(c[d]);
              } catch (e) {
                (d = c = void 0),
                  null == (d = (c = C5).Nz) || d.call(c, "unknown", e);
              }
            }
          });
        });
    ...
    G5 = function (a, b) {
      return F5.apply(null, [a, b].concat(g.qa(g.Ia.apply(2, arguments))));
    },
    H5 = function (a, b) {
      var c = F5;
      F5 = a;
    ...
    L5 = function (a) {
      return a instanceof g.ae || a instanceof g.fe || a instanceof g.pe || !1;
    },
    Urb = function (a, b) {
      ...
      a.isDisposed ||
        ...
        1 === O5.size &&
          Promise.resolve().then(function () {
            for (var b = g.u(O5), c = b.next(); !c.done; c = b.next())
              (c = c.value), O5.delete(c), c.WF();
          }));
    },
    $rb = function (a, b, c) {
      var d = Drb(
    ...
    dsb = function (a) {
      var b = [];
      (({}).Ymb ? bsb : asb)(function () {
        var c = b[0],
          d = b.Eq,
          e = H5(P5, a);
        c = csb(c, e, b);
        Array.isArray(c) || (b.Eq = [c]);
        e = b.Eq;
        if (d) {
    ...
    csb = function (a, b, c) {
      ...
      if (null != b && b[E5]) {
        var d;
        throw Error(
          "Encountered a VNode when only real nodes are expected. Tag name: " +
            (null == (d = b.type) ? void 0 : d.Vu)
        );
      }
      if (null == a)
        return null == b
          ...
          : esb(b, c);
      if (N5(a)) {
        if (null == b) return Urb(a, I5());
        if (K5(b)) return Vrb(a, b);
        if (L5(b)) return Vrb(a, b.toString());
        if (N5(b)) return Urb(a, b);
        if (0 === b.length) return Urb(a, I5());
        b = esb(b, c);
        Wrb([a], c.Eq);
        return b;
      }
      a = fsb(a);
      if (null == b) return M5(a, I5());
      if (K5(b)) return M5(a, J5(b));
      if (L5(b)) return M5(a, J5(b.toString()));
      if (N5(b)) return Wrb(a, [b])[0];
      if (0 === b.length) return M5(a, I5());
      b = esb(b, c);
      Wrb(a, c.Eq);
      return b;
    },
    ...
    R5 = function (a, b, c, d, e) {
      ...
      e = void 0 === e ? -1 : e;
      if (null == a) return b;
      K5(a) && ((a = J5(a)), d && c && (d[e] = a));
      L5(a) && ((a = J5(a.toString())), d && c && (d[e] = a));
      if (N5(a)) return gsb(b, a);
      if (Array.isArray(a)) {
        for (d = 0; d < a.length; d++) R5(a[d], b, c, a, d);
        return b;
      }
      if ("function" === typeof a)
        return (a = dsb(a)[0]), d && c && (d[e] = a), gsb(b, a);
      if (null != a && a[E5]) {
        var f = a;
        a = H5(P5, function () {
          return G5.apply(null, [f.type, f.props].concat(g.qa(f.children)));
        });
        return R5(a, b, c);
      }
    ...
    isb = function (a, b) {
      ...
      var f = x5(function (p) {
          d = p;
          c = H5(P5, function () {
            return w5(hsb, function () {
              return a(b);
            });
          });
        }),
        h = null != c && c.Eq ? c.Eq : c,
        l = Array.isArray(h) ? h[0] : h;
      if (l) {
        var m,
          n = null != (m = null == b ? void 0 : b.idomKey) ? m : a;
        m = a.z1;
        l._disposeEffects = f;
        f = l[Q5] || {};
        Object.assign(f, {
    ...
    lsb = function (a, b, c) {
      if (
        Object.hasOwnProperty.call(jsb, a) &&
        ((a = jsb[a]),
    ...
    S5 = function (a, b, c) {
      if (!1 === c && osb.has(b)) crb(a, b, null);
        ...
        if (b.startsWith("on"))
              ...
              if (z5 && z5.uw)
                ...
                if (psb.includes(f))
                  throw Error(
                    "The on:" +
                      f +
                      " attribute is not supported in an IDOM component because Element#on" +
                      (f + " is not a valid property.")
                  );
                a["on" + f] = e;
              }
            }
          ...
          "function" !== typeof c || null != a._disposeEffects
            ? (C5.U6 && (c = nsb(a, b, c)),
              "style" === b
                ? rsb(a, b, c)
                : b.startsWith("prop:")
    ...
    ssb = function (a, b, c) {
      ...
      if (null == b ? 0 : b.el) {
        ...
        if ("function" === typeof d) d(a);
          ...
          var e;
          null == (e = d.Aaa) || e.call(d, a);
          a._disposeRef ||
            ((a._disposeRef = function () {
              var f;
              null == (f = d.xba) || f.call(d);
    ...
    tsb = function (a, b) {
      null == a._disposeEffects &&
        null != a._signalProps &&
        (a._disposeEffects = x5(function () {
          asb(function () {
            for (
    ...
    xsb = function (a, b) {
      ...
      if ("function" === typeof a) {
        var d = b;
        0 < c.length && (d.children = 1 === c.length ? c[0] : c);
        c = vsb(a, d);
        !1 === c && (c = wsb(a, d));
        return c;
      }
      d = document.createElement(a);
      for (var e in b) S5(d, e, b[e]);
      tsb(d, b);
      fsb(c, d);
      ssb(d, b, { uw: !0 });
      return d;
    ...
    vsb = function (a, b) {
      if (a.Bob || a.uw) return !1;
      b || (b = {});
      var c = new B5(b);
      c.B = a;
      var d = w5(hsb, function () {
        return c.wx(b);
      });
    ...
    Bsb = function (a) {
      ...
      if (a !== d[c].key) {
        var e, f;
        a =
          (null == (e = b.j) ? void 0 : e.name) ||
          (null == (f = b.B) ? void 0 : f.name);
        throw Error(
    ...
    Dsb = function (a, b) {
      var c = Bsb("onChange"),
        d = Mrb();
      Csb(c.Wg, b) &&
        ((c.Wg = b), (c.k_ = a), d.Ny || (d.Ny = []), d.Ny.push(c));
    },
    T5 = function (a, b) {
      Dsb(function () {
        return w5(null, a);
    ...
    U5 = function (a) {
      var b = [];
      if (z5 && z5.uw) return a();
      var c = Bsb("useMemoInternal");
      Csb(c.Wg, b) && ((c.Wg = b), (c.value = a()));
      return c.value;
    },
    V5 = function () {
      var a = U5(function () {
        return Asb(function (b) {
          a.value = b;
          return function () {
            a.value = null;
          };
    ...
    Lsb = function (a, b, c) {
      ((void 0 === c ? 0 : c) ? Jsb : Ksb)(a, function () {
        W5(b);
      });
    },
    W5 = function (a) {
      if (void 0 !== a && null !== a)
        if (Array.isArray(a)) {
        ...
        } else if (a instanceof g.ae || a instanceof g.fe || a instanceof g.pe)
          rrb(a.toString());
        else if (N5(a)) {
          if (g5() !== a)
            throw Error(
          ...
          var c = typeof a;
          if ("boolean" === c || "number" === c || "string" === c) rrb(a);
            ...
            if ("string" === typeof a.type) {
              a.tq || nrb(a.type, a.props.idomKey);
              d = f5;
              for (var h in a.props)
                a.props[h] !== Msb &&
                  ((e = a.props[h]), (f = n5), f.push(h), f.push(e));
              e = C5.attributes;
              e = void 0 === e ? Nsb : e;
              f = f5;
              var l = e5(f),
                m = e;
              e = n5;
              l = l.j || (l.j = brb(e.length));
              for (var n = !l.length || !1, p = 0; p < e.length; p += 2) {
                h = e[p];
                if (n) l[p] = h;
                else if (l[p] !== h) break;
                var q = e[p + 1];
                if (n || l[p + 1] !== q) (l[p + 1] = q), qrb(f, h, q, m);
              }
              if (p < e.length || p < l.length) {
                for (p = n = p; p < l.length; p += 2) X5[l[p]] = l[p + 1];
                for (p = n; p < e.length; p += 2)
                  (n = e[p]),
                    (h = e[p + 1]),
                    X5[n] !== h && qrb(f, n, h, m),
                    (l[p] = n),
                    ...
                    delete X5[n];
                d5(l, e.length);
                for (b in X5) qrb(f, b, void 0, m), delete X5[b];
              }
              b = Osb;
              Osb = f = p5.length;
              for (m = b; m < f; m += 5)
                (0, p5[m])(p5[m + 1], p5[m + 2], p5[m + 3], p5[m + 4]);
              Osb = b;
              d5(p5, b);
              d5(e, 0);
              tsb(d, a.props);
              (a.props.skip || a.props.skipchildren) && f5.hasChildNodes()
                ? (j5 = f5.lastChild)
                : W5(a.children);
              i5(null);
              j5 = f5;
            ...
            if (a.type === Trb) W5(a.children);
            else if (!Psb(a)) {
              try {
                f = a.type;
                var r = f.Vu;
                if (f === Isb) (a.props.children = a.children), f(a.props);
                else {
                  ...
                  if (!m) {
                    ...
                    var w = a.props,
                      A;
                    if (
                      void 0 === (null == (A = f.prototype) ? void 0 : A.wx)
                    ) {
                      var C = new B5(w);
                      C.B = f;
                    } else C = new f(w);
                    C.j = f;
                    C.KM = { hQ: C.state, uP: !1 };
                    m = C;
                    m.props = null;
                    v && ((v.__instance = m), (m.el = v));
                  }
                  var F,
                    G = null != (F = m.KM) ? F : { hQ: m.state, uP: !1 },
                    L = G.uP,
                    N = G.hQ;
                  m.KM = void 0;
                  f.y7 && (N = f.y7(a.props, N));
                  b = !b && !L && !1;
                  m.props = a.props;
                  m.state = N;
                  if (b) j5 = f5.lastChild;
                  else {
                    b = m;
                    D5.LV(b);
                    var R = b.wx(b.props);
                    R
                      ? (b.props.idomKey && (R.props.idomKey = b.props.idomKey),
                        (q = R))
                      : (q = void 0);
                    if ((b = q))
                      if (((b.tq = a.tq), (l = W5(b)), (a.tq = b.tq), !f.Vu))
                        if (l)
                          (f.Vu = l.tagName.toLowerCase()),
                            (l.__instance = m),
                            (m.el = l);
                        else if (null == (p = m.Sz) ? 0 : p.length)
                          null == (n = C5.Nz) ||
                            n.call(
                              C5,
                              "unknown",
                ...
                (b = ea),
                  null == (e = C5.Nz) ||
                    e.call(C5, null == (d = a.type) ? void 0 : d.Vu, b);
              }
              a.tq && (i5(null), (j5 = f5), (f5 = f5.parentNode), (a.tq = !1));
            }
          }
        }
    },
    Psb = function (a) {
      ...
      var c,
        ...
        e;
      if (g5() && (null == (e = g5()[Q5]) ? void 0 : e.key) === d) {
        d = g5();
        c = d[Q5];
        if (!c)
          throw Error(
            "Reactive data has been lost on node. Tag name: " + d.tagName
          );
        if (!b.z1) {
          for (b = 0; b < c.uZ; b++) j5 = g5();
          var f;
          null == (f = c.eqb) || f.call(c, a.props);
          return !0;
        }
        f = q5;
        b = b.z1(a.props, c.props, null !== f ? f : c.owner, c.E8);
        a = a.props;
        if ((c = c.props))
          (c.children = a.children), (c.T6 = a.T6), (c.fallback = a.fallback);
        W5(b);
        return !0;
      }
      a = isb(a.type, a.props);
      a = null != a && a.Eq ? a.Eq : a;
      a = Array.isArray(a) ? a : [a];
      a = g.u(a);
      for (b = a.next(); !b.done; b = a.next())
        f5.insertBefore(b.value, g5()), (j5 = g5());
      return !0;
    },
    Qsb = function (a) {
      var b = Mrb(),
      ...
      return [
        c.value,
        function (d) {
          if (null !== A5) throw Error("Can't set state during rendering");
          c.value = "function" === typeof d ? d(c.value) : d;
          b.KM = { hQ: b.state, uP: !0 };
          r5(b.YH, function () {
            H5(Srb, function () {
              if (b.el) {
                var e,
                  ...
                  h =
                    ((f.props = b.props),
                    (f.type = b.j),
                    (f.children = null != (e = b.props.children) ? e : []),
                    (f[E5] = !0),
                    f);
                try {
                  Lsb(b.el, h, !0);
                  ...
                  var l, m;
                  null == (m = C5.Nz) ||
                    m.call(C5, null == (l = b.j) ? void 0 : l.Vu, n);
                }
              }
            });
          });
    ...
    Vsb = function (a) {
      ...
      Usb ||
        (b(function () {
          for (var c = g.u(Tsb), d = c.next(); !d.done; d = c.next())
            (d = d.value), d();
          Tsb.length = 0;
          Usb = !1;
        }),
    ...
    Xsb = function (a) {
      function b() {
        var l = a.J.Yc() ? "Hide more shorts" : "Hide more videos";
        e(l);
      }
      var c = g.u(Qsb("Hide more videos")),
        d = c.next().value,
        e = c.next().value;
      T5(
        function () {
      ...
      return G5(
        "button",
        {
          ...
          "aria-label": d,
          "on:click": Hsb(function () {
            a.action && a.action();
          }),
        },
        G5("div", { class: "ytp-collapse-icon", el: h, skip: !0 })
      );
    },
    Ysb = function (a) {
      function b() {
        var h = a.J.Yc() ? "More shorts" : "More videos";
        e(h);
      }
      var c = g.u(Wsb("More videos")),
        d = c.next().value,
        e = c.next().value,
        f = V5();
      T5(
        function () {
          a.pB && (a.pB.value = f.value);
        },
        [a.pB]
      );
      T5(
    ...
    $sb = function (a) {
      function b(w) {
        ...
        if (!A) {
          ...
          null != (F = p.value) &&
            F.iE() &&
            h(g.kG(w, 4) && !g.kG(w, 2) && !g.kG(w, 1024));
        }
      }
      function c() {
        b(a.J.Rb());
      ...
      T5(
        function () {
          ...
          g.uv(w.getRootNode(), "ytp-pause-overlay-controls-hidden", A);
          return function () {
            w.removeEventListener("videodatachange", c);
            w.removeEventListener("presentingplayerstatechange", d);
            var C;
            null == (C = r.value) || C.dispose();
          };
        },
        [a.J]
      );
      ...
      var t = a.J;
      if (f)
        if ((g.uv(t.getRootNode(), "ytp-expand-pause-overlay", !e), e))
          l.value.focus();
        else {
          var v = p.value;
          g.j2(v);
    ...
    atb = function (a) {
      g.W.call(this, { I: "div", S: "ytp-related-on-error-overlay" });
      var b = this;
      this.api = a;
      this.K = this.B = 0;
      this.G = new g.uK(this);
      this.j = [];
      this.suggestionData = [];
      ...
      this.previous = new g.W({
        ...
        X: { "aria-label": "Show previous suggested videos" },
        V: [g.HF()],
      });
      this.qa = new g.h2(function (f) {
      ...
      this.next = new g.W({
        ...
        X: { "aria-label": "Show more suggested videos" },
        V: [g.IF()],
      });
      g.O(this, this.G);
      a = a.U();
      this.api.L("embeds_web_enable_pause_overlay_rounding") &&
        g.pv(this.element, "ytp-error-overlay-round-corners");
      this.Y = a.D;
      g.O(this, this.title);
      this.title.Ja(this.element);
      this.suggestions = new g.W({ I: "div", S: "ytp-suggestions" });
      g.O(this, this.suggestions);
      this.suggestions.Ja(this.element);
      g.O(this, this.previous);
      this.previous.Ja(this.element);
      this.previous.listen("click", this.e3, this);
      g.O(this, this.qa);
      for (var c = { Wz: 0 }; 16 > c.Wz; c = { Wz: c.Wz }, c.Wz++) {
        var d = new g.W({
          I: "a",
          S: "ytp-suggestion-link",
          X: { href: "{{link}}", target: a.Y, "aria-label": "{{aria_label}}" },
          V: [
            {
              I: "div",
        ...
        g.xs(e, "transitionDelay", c.Wz / 20 + "s");
        this.G.T(
          e,
          "click",
          (function (f) {
            return function (h) {
              ...
              b.api.L(
                ...
                ? (b.api.logClick(b.j[l].element),
                  (l = m.Nk()),
                  (m = {}),
                  g.uVa(b.api, m, "emb_rel_err"),
                  (l = g.Jn(l, m)),
                  g.uU(l, b.api, h))
                : g.tU(h, b.api, b.Y, n || void 0) &&
                  b.api.Ho(m.videoId, n, m.playlistId);
            };
          })(c)
        );
        this.j.push(d);
      ...
      this.next.listen("click", this.d3, this);
      this.G.T(this.api, "videodatachange", this.onVideoDataChange);
      this.resize(this.api.jb().getPlayerSize());
    ...
    ctb = function (a) {
      ...
      g.uv(a.element, "ytp-scroll-min", 0 <= b);
      g.uv(a.element, "ytp-scroll-max", b <= c);
    },
    dtb = function (a) {
      for (var b = 0; b < a.suggestionData.length; b++) {
        ...
        if (
          ...
          var l = {};
          g.JT(a.api, "addEmbedsConversionTrackingParams", [l]);
          f = g.Jn(f, g.eP(l, "emb_rel_err"));
        }
        d.element.style.display = "";
        l = d.Fa("ytp-suggestion-title");
        g.zv.test(c.title)
          ? (l.dir = "rtl")
          : g.Ajb.test(c.title) && (l.dir = "ltr");
        l = d.Fa("ytp-suggestion-author");
        g.zv.test(e) ? (l.dir = "rtl") : g.Ajb.test(e) && (l.dir = "ltr");
        d.update({
          views_or_author: e,
          duration: c.isLivePlayback
            ? "Live"
            : c.lengthSeconds
            ? g.AG(c.lengthSeconds)
            : "",
          link: f,
          hover_title: c.title,
          title: c.title,
    ...
    Y5 = function (a) {
        ...
        V: [
          {
            ...
            V: [
              { I: "path", X: { d: "M0 0h24v24H0V0z", fill: "none" } },
              {
                I: "path",
                X: {
      ...
      g.O(this, f);
      a.U().C ||
        ((this.j = new atb(a)), this.j.Ja(this.element), g.O(this, this.j));
    ...
    etb = function (a, b, c) {
      ...
      c = {};
      g.JT(a.api, "addEmbedsConversionTrackingParams", [c]);
      b = g.nd(c) ? b : g.Jn(b, c);
      g.Se(b);
    },
    ftb = function (a, b) {
    ...
    itb = function (a, b) {
      var c = a.api.U(),
        d;
      b.reason &&
        (gtb(b.reason) ? (d = g.GF(b.reason)) : (d = g.NV(g.FF(b.reason))),
        a.Jd(d, "content"));
      var e;
      b.subreason &&
        (gtb(b.subreason)
          ? (e = g.GF(b.subreason))
          : (e = g.NV(g.FF(b.subreason))),
        a.Jd(e, "subreason"));
      if (b.proceedButton && b.proceedButton.buttonRenderer) {
        ...
        if (
          ...
          ((e = b.text.simpleText),
          (f.textContent = e),
          !htb(d, e) && (!c.C || c.embedsErrorLinks))
        ) {
          var h;
          c =
            null == (h = g.V(null == b ? void 0 : b.navigationEndpoint, g.RF))
              ? void 0
              : h.url;
          var l;
          h =
            null == (l = g.V(null == b ? void 0 : b.navigationEndpoint, g.RF))
              ? void 0
              : l.target;
          c &&
    ...
    Z5 = function (a, b) {
        ...
        V: [
          {
            ...
            V: [
              ...
              { I: "div", S: "ytp-impression-link-logo", V: [$qb()] },
            ],
          },
        ],
      });
      ...
      this.T(this.api, "presentingplayerstatechange", this.jk);
    ...
    jtb = function (a) {
      var b = {};
      g.JT(a.api, "addEmbedsConversionTrackingParams", [b]);
      return g.Jn(a.api.getVideoUrl(), g.eP(b, "emb_imp_woyt"));
    },
    $5 = function (a) {
      g.W.call(this, {
        I: "div",
        ...
        V: [
          {
            ...
            X: { "aria-label": "Rewind 10 seconds", "aria-hidden": "false" },
          },
          {
            I: "button",
    ...
    b6 = function (a) {
      ...
      g.W.call(this, {
        ...
        X: {
          target: b.Y,
          href: "{{url}}",
          "aria-label": g.JJ("Watch on $WEBSITE", { WEBSITE: g.TR(b) }),
    ...
    mtb = function (a) {
            ...
            V: [
              {
                ...
                X: { "aria-label": "Muted Playback Indicator" },
                V: [
                  {
                    I: "div",
                            ...
                            V: [
                              {
                                ...
                                X: { height: "9", width: "4", x: "1", y: "7" },
                              },
                              {
                                I: "rect",
                                S: "ytp-equalizer-bar-middle",
                                X: { height: "14", width: "4", x: "6", y: "2" },
                              },
                              {
                                I: "rect",
      ...
      this.C = new g.cv(this.D8, 4e3, this);
      this.B = !1;
      a.createClientVe(this.element, this, 39306);
      this.T(a, "presentingplayerstatechange", this.XL);
      ...
      this.hide();
      g.NT(a.app) && (ktb(this), this.XL(), ltb(this));
      g.O(this, this.C);
    },
    ltb = function (a) {
      a.Bb && a.j && (a.j.show(), a.C.start());
    },
    ktb = function (a) {
      a.watermark ||
        ((a.watermark = new b6(a.api)),
        g.O(a, a.watermark),
        a.watermark.Ja(a.bottomButtons, 0),
        g.uv(a.watermark.element, "ytp-muted-autoplay-watermark", !0),
        (a.j = new g.eG(a.watermark, 0, !0, 100)),
        g.O(a, a.j));
    },
    c6 = function (a) {
      g.W.call(this, {
      ...
      this.expandButton = new g.W({
        ...
        xa: this.api.Yc() ? "More shorts" : "More videos",
      });
      "0" === a.U().controlsType &&
        g.pv(a.getRootNode(), "ytp-pause-overlay-controls-hidden");
      this.api.L("embeds_web_enable_pause_overlay_rounding") &&
        g.pv(this.element, "ytp-pause-overlay-round-corners");
      g.O(this, this.C);
      g.O(this, this.D);
      var c = new g.W({
        I: "button",
        ...
        X: {
          "aria-label": this.api.Yc() ? "Hide more shorts" : "Hide more videos",
        },
        V: [{ I: "div", S: "ytp-collapse-icon", V: [g.LF()] }],
      });
      g.O(this, c);
      c.Ja(this.element);
      c.listen("click", this.G, this);
      g.O(this, this.expandButton);
    ...
    stb = function (a) {
      ...
      if (
        ...
        a.J.Yc() &&
          ...
          g.O(a, a.D),
          g.bU(a.J, a.D.element, 4),
          (a.B = new g.eG(a.D, 1e3, !1, 100)),
          g.O(a, a.B),
          a.D.hide());
        a.G = new g.W({
          I: "div",
        ...
        a.J.L("embeds_web_enable_keto_pause_overlay")
          ? ((b = a.G.element), (c = G5($sb, { J: a.J, Re: c })), Lsb(b, c, !1))
          : ((a.C = new c6(a.J, c)), g.O(a, a.C), a.C.Ja(a.G.element));
        g.bU(a.J, a.G.element, 4);
        rtb(a, a.J.Rb());
      }
    },
    rtb = function (a, b) {
      a.B &&
        ((!g.kG(b, 4) && !g.kG(b, 2)) || g.kG(b, 1024)
          ? a.B.hide()
          : a.B.show());
    },
    ptb = function (a) {
      var b = a.J;
      a = !!b.Yc();
      g.uv(b.getRootNode(), "ytp-shorts-mode", a);
      if ((b = b.getVideoData())) b.jV = a;
    },
    f6 = function (a, b) {
      var c = a.J.U();
      a = {
        ...
        embedUrl: g.Efa(a.J.U().loaderUrl),
        eventType: b,
        youtubeHost: g.bn(a.J.U().Ga) || "",
      };
      a.embeddedPlayerMode = c.Da;
      g.KC("embedsAdEvent", a);
    };
  var z5 = null;
  var drb = Object.prototype.hasOwnProperty;
  arb.prototype = Object.create(null);
  var Nsb = grb();
  var o5 = null;
  var orb =
  ...
  var ttb = Symbol("UNSET"),
    utb = Symbol("COMPUTING"),
    vtb = Symbol("ERRORED");
  Object.assign({}, v5, {
    value: ttb,
    Yl: !0,
    ...
    HW: srb,
    E_: function (a) {
      return a.value === ttb || a.value === utb;
    },
    F_: function (a) {
      if (a.value === utb) throw Error("Detected cycle in computations.");
      var b = a.value;
      a.value = utb;
      var c = vrb(a);
      try {
      ...
      b !== ttb && b !== vtb && d !== vtb && a.HW(b, d)
        ? (a.value = b)
        : ((a.value = d), a.version++);
    },
  });
  Object.assign({}, v5, { HW: srb, value: void 0 });
  var Arb = Object.assign({}, v5, {
    iW: !0,
    BN: !1,
    jW: function (a) {
      null !== a.schedule && a.schedule(a.pB);
    },
    WX: !1,
    Zy: Brb,
  });
  ...
  y5.prototype.lD = function () {};
  y5.prototype.H6 = function () {};
  y5.prototype.TH = function () {};
  y5.prototype.I6 = function () {};
  var A5 = null;
  g.y(B5, y5);
  B5.prototype.wx = function (a) {
    var b = this,
      c = A5;
    Nrb(this);
    this.D = 0;
  ...
  var F5 = Srb;
  var P5;
  var Msb = Symbol("ATTR_TAG_VALUE");
  var Q5 = Symbol("reactiveData");
  var Xrb = new Set(),
    O5 = new Set();
  var wsb = isb;
  var osb = new Set(
  ...
  var ksb = {
    ...
    jsb = {
      ...
      area: { href: [{ Ad: 3 }] },
      audio: { src: [{ Ad: 3 }] },
      button: { formaction: [{ Ad: 3 }], formmethod: [{ Ad: 1 }] },
      form: { action: [{ Ad: 3 }], method: [{ Ad: 1 }] },
      iframe: { srcdoc: [{ Ad: 2 }] },
      img: { src: [{ Ad: 3 }] },
      input: {
        accept: [{ Ad: 1 }],
      ...
      link: {
        href: [
          { Ad: 3, ri: "rel", Gi: "alternate" },
          { Ad: 3, ri: "rel", Gi: "author" },
          { Ad: 3, ri: "rel", Gi: "bookmark" },
          { Ad: 3, ri: "rel", Gi: "canonical" },
          { Ad: 3, ri: "rel", Gi: "cite" },
          { Ad: 3, ri: "rel", Gi: "help" },
          { Ad: 3, ri: "rel", Gi: "icon" },
          { Ad: 3, ri: "rel", Gi: "license" },
          { Ad: 3, ri: "rel", Gi: "next" },
          { Ad: 3, ri: "rel", Gi: "prefetch" },
          { Ad: 3, ri: "rel", Gi: "dns-prefetch" },
          { Ad: 3, ri: "rel", Gi: "prerender" },
          { Ad: 3, ri: "rel", Gi: "preconnect" },
          { Ad: 3, ri: "rel", Gi: "preload" },
          { Ad: 3, ri: "rel", Gi: "prev" },
          { Ad: 3, ri: "rel", Gi: "search" },
          { Ad: 3, ri: "rel", Gi: "subresource" },
        ],
      },
      script: { defer: [{ Ad: 1 }] },
      source: { src: [{ Ad: 3 }] },
      textarea: { readonly: [{ Ad: 1 }] },
      video: { src: [{ Ad: 3 }] },
    };
  g.ew.getInstance();
  var wtb = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:\/?#]*(?:[\/?#]|$))/i,
    g6 = {},
    msb =
      ((g6[1] = { Dq: null, Dt: null, Sr: null }),
      (g6[2] = {
        Dq: function () {
          return g.me.toString();
        },
        Dt: function (a) {
          return a instanceof g.ue;
        },
        Sr: function (a) {
          return g.we(a);
        },
      ...
      (g6[3] = {
        Dq: function (a, b, c) {
          return wtb.test(c) ? c : g.me.toString();
        },
        Dt: function (a) {
          return a instanceof g.fe;
        },
        Sr: function (a) {
          return g.ge(a);
        },
      ...
      (g6[5] = {
        Dq: null,
        Dt: function (a) {
          return a instanceof g.pe;
        },
        Sr: function (a) {
          return a.toString();
        },
      }),
      (g6[7] = { Dq: null, Dt: null, Sr: null }),
      (g6[8] = { Dq: null, Dt: null, Sr: null }),
      (g6[10] = {
        Dq: null,
        Dt: function (a) {
  ...
  var xtb = grb(),
    qsb = xtb.__default,
    rsb = xtb.style,
    psb = ["focusin", "focusout"];
  P5 = xsb;
  (function (a) {
    var b = {},
      c;
    for (c in a)
      (b = { x_: void 0, nZ: void 0 }),
        (b.x_ = D5[c]),
        (b.nZ = a[c]),
        (D5[c] = (function (d) {
          return function () {
            var e = g.Ia.apply(0, arguments);
            d.x_.apply(null, g.qa(e));
            d.nZ.apply(null, g.qa(e));
          };
        })(b));
  })({
    LV: function (a) {
      r5(a.YH, function () {
        var b;
        (null == (b = a.Ny) ? 0 : b.length) && Gsb(a.Ny);
      });
    },
    lD: function (a) {
      r5(a.YH, function () {
    ...
    TH: function (a) {
      var b;
      (null == (b = a.Sz) ? 0 : b.length) && a.Sz.forEach(Fsb);
    },
  });
  P5 = xsb;
  var ytb = {},
    ztb =
      ((ytb.__default = function () {
        return S5;
      }),
      (ytb.style = function () {
        return S5;
      ...
      ytb),
    h6;
  for (h6 in ztb) C5.attributes[h6] = ztb[h6](C5.attributes[h6]);
  var Tsb = [],
    Usb = !1;
  g.y(atb, g.W);
  g.k = atb.prototype;
  ...
  g.k.resize = function (a, b) {
    ...
    if (150 >= Math.min(a.width, a.height) || 0 === h || !c.ud) this.hide();
      ...
      b &&
        ...
        (m = a / l - this.B),
        (q = Math.floor(m / d)));
      50 > m || g.ZT(this.api) ? this.hide() : this.show();
      for (b = 0; b < h; b++) {
        d = this.j[b];
  ...
  g.k.onVideoDataChange = function () {
    ...
    this.Y = a.Jf ? !1 : b.D;
    a.suggestions
      ? (this.suggestionData = g.Dt(a.suggestions, function (c) {
    ...
    a.Jf
      ? this.title.update({
          title: g.JJ("More videos from $DNI_RELATED_CHANNEL", {
  ...
  Y5.prototype.show = function () {
    ...
    ftb(this, this.api.jb().getPlayerSize());
  };
  Y5.prototype.resize = function (a) {
  ...
  Y5.prototype.B = function (a) {
    ...
    if (b.DC || b.playerErrorMessageRenderer)
      (a = b.DC)
        ? itb(this, a)
        : b.playerErrorMessageRenderer &&
          itb(this, b.playerErrorMessageRenderer);
    else {
      var c;
      a.pn &&
        (b.By
  ...
  g.y(Z5, g.W);
  Z5.prototype.jk = function () {
    this.api.Rb().isCued() ||
      (this.hide(), this.api.logVisibility(this.element, !1));
  };
  Z5.prototype.j = function () {
    var a = this.api.getVideoData(),
      b = this.api.U(),
      ...
      f = this.Re.Lg();
    b = b.C;
    d || f || c || e || b || this.api.Yc() || !a.videoId
      ? (this.hide(), this.api.logVisibility(this.element, !1))
      : ((a = jtb(this)), this.updateValue("url", a), this.show());
  };
  Z5.prototype.onClick = function (a) {
  ...
  g.y($5, g.W);
  $5.prototype.jk = function () {
    var a = this.api.Rb();
    !this.api.Yh() || (g.kG(a, 2) && g.VT(this.api)) || g.kG(a, 64)
  ...
  a6.prototype.C = function () {
    ...
    this.api.getVideoData().mutedAutoplay &&
      (g.kG(a, 2) && !this.Bb
        ? (this.show(),
          this.j ||
            ((this.j = new g.KV(this.api)),
            g.O(this, this.j),
            this.j.Ja(this.D, 0),
            this.j.show()),
          (a = this.api.getVideoData()),
          this.updateValue("text", a.hT),
          g.uv(this.element, "ytp-muted-autoplay-show-end-panel", !0),
          this.api.logVisibility(this.element, this.Bb),
          this.api.vc("onMutedAutoplayEnds"))
        : this.hide());
  };
  a6.prototype.onClick = function () {
    if (!this.B) {
  ...
  a6.prototype.onMutedAutoplayStarts = function () {
    this.B = !1;
    this.j && (this.j.va(), (this.j = null));
  };
  g.y(b6, g.W);
  ...
  g.k.D1 = function () {
    var a = this.api.getVideoData(),
      b =
        this.api.U().Td &&
        !g.kG(this.state, 2) &&
        !g.DT(this.api.getVideoData(1));
    a.mutedAutoplay || g.BF(this, b);
  ...
  g.k.onVideoDataChange = function () {
    var a = this.api.U();
    a.C && g.pv(this.element, "ytp-no-hover");
  ...
  g.k.onClick = function (a) {
    this.api.L("web_player_log_click_before_generating_ve_conversion_params") &&
      this.api.logClick(this.element);
    var b = this.api.getVideoUrl(!g.BG(a), !1, !0, !0);
    if (
      this.api.L("web_player_log_click_before_generating_ve_conversion_params")
    ) {
      var c = {};
      g.JT(this.api, "addEmbedsConversionTrackingParams", [c]);
      b = g.Jn(b, g.eP(c, "emb_yt_watermark"));
    }
    g.uU(b, this.api, a);
    this.api.L("web_player_log_click_before_generating_ve_conversion_params") ||
      this.api.logClick(this.element);
  ...
  g.k.XL = function () {
    var a = this.api.Rb();
    !this.api.getVideoData().mutedAutoplay || g.kG(a, 2)
      ? this.hide()
      : this.Bb ||
        (g.W.prototype.show.call(this),
        this.api.logVisibility(this.element, this.Bb));
  ...
  g.y(c6, g.W);
  c6.prototype.hide = function () {
    g.rv(this.api.getRootNode(), "ytp-expand-pause-overlay");
    g.W.prototype.hide.call(this);
  };
  c6.prototype.G = function () {
    this.B = !0;
    g.rv(this.api.getRootNode(), "ytp-expand-pause-overlay");
    this.api.Yc() && this.api.logVisibility(this.element, !1);
    this.expandButton.focus();
  };
  c6.prototype.K = function () {
    this.B = !1;
    g.pv(this.api.getRootNode(), "ytp-expand-pause-overlay");
    this.api.Yc() && this.api.logVisibility(this.element, !0);
    this.focus();
  };
  c6.prototype.Ra = function () {
    var a = this.api.Rb();
    g.kG(a, 1) ||
      g.kG(a, 16) ||
      g.kG(a, 32) ||
      (!g.kG(a, 4) || g.kG(a, 2) || g.kG(a, 1024)
  ...
  g.k.create = function () {
    ...
    d && g.yH({ clientPlaybackNonce: d });
    a.Ya && stb(this);
    this.Z = new mtb(this.J);
    g.O(this, this.Z);
    g.bU(this.J, this.Z.element, 4);
    this.ra = new a6(this.J);
    g.O(this, this.ra);
    g.bU(this.J, this.ra.element, 4);
    a.Td &&
      ((this.watermark = new b6(this.J)),
      g.O(this, this.watermark),
      g.bU(this.J, this.watermark.element, 8));
    b &&
      ((this.K = new Z5(this.J, b)),
      g.O(this, this.K),
      g.bU(this.J, this.K.element, 8),
      g.NT(this.J.app) && (this.onMutedAutoplayStarts(), this.K.hide()));
    a.B &&
      ((this.qa = new $5(this.J)),
      g.O(this, this.qa),
      g.bU(this.J, this.qa.element, 4));
    this.j.T(this.J, "appresize", this.Tb);
    this.j.T(this.J, "presentingplayerstatechange", this.jk);
    ...
    if ((this.N = g.ZB(g.PR(a))))
      (this.countdownTimer = new d6(this.J)),
        g.O(this, this.countdownTimer),
        g.bU(this.J, this.countdownTimer.element, 4),
        this.countdownTimer.hide(),
        this.j.T(this.J, g.DJ("embeds"), this.onCueRangeEnter),
        this.j.T(this.J, g.EJ("embeds"), this.onCueRangeExit);
    this.Ac(this.J.Rb());
    this.player.Bg("embed");
    var e, f;
    (null == (e = this.J.U().getWebPlayerContextConfig())
      ? 0
      : null == (f = e.embedsHostFlags)
      ? 0
      : f.allowOverridingVisitorDataPlayerVars) &&
      (a = g.$A("IDENTITY_MEMENTO")) &&
      this.J.Cm("onMementoChange", a);
  };
  g.k.onCueRangeEnter = function (a) {
    "countdown timer" === a.getId() &&
      this.countdownTimer &&
      (this.countdownTimer.show(), otb(this.countdownTimer));
  };
  g.k.onCueRangeExit = function (a) {
    "countdown timer" === a.getId() &&
      this.countdownTimer &&
      (e6(this.countdownTimer), this.countdownTimer.hide());
  };
  g.k.Tb = function () {
    var a = this.J.jb().getPlayerSize();
    this.vg && this.vg.resize(a);
  };
  ...
  g.k.Ac = function (a) {
    g.kG(a, 128)
      ? (this.vg ||
          ((this.vg = new Y5(this.J)),
          g.O(this, this.vg),
          g.bU(this.J, this.vg.element, 4)),
        this.vg.B(a.Jg),
        this.vg.show(),
        g.pv(this.J.getRootNode(), "ytp-embed-error"))
      : this.vg &&
        (this.vg.dispose(),
        (this.vg = null),
        g.rv(this.J.getRootNode(), "ytp-embed-error"));
    if (this.countdownTimer && this.countdownTimer.j)
      if (g.kG(a, 64)) this.countdownTimer.hide(), e6(this.countdownTimer);
      else if (a.isPaused()) {
        var b = this.countdownTimer;
        b.B || ((b.B = !0), (b.G = (0, g.YC)()));
      } else
        a.isPlaying() &&
          this.countdownTimer.B &&
          ((b = this.countdownTimer),
          b.B && ((b.D += (0, g.YC)() - b.G), (b.B = !1), ntb(b)));
    rtb(this, a);
  };
  g.k.onMutedAutoplayStarts = function () {
    this.J.getVideoData().mutedAutoplay &&
      this.Z &&
      g.uv(this.J.getRootNode(), "ytp-muted-autoplay", !0);
  };
  g.k.onVideoDataChange = function (a, b) {
    var c = this.DE !== b.videoId;
    a = !c && "dataloaded" === a;
    var d = { isShortsModeEnabled: !!this.J.Yc() };
    g.KC("embedsVideoDataDidChange", {
    ...
    c &&
      ...
      this.N &&
        ...
        b.isAd() ||
          ...
          this.J.kf([b]))),
      this.J.U().Ya && (ptb(this), stb(this)));
    this.J.U().C && this.C && this.C.detach();
  };
  g.k.onAdStart = function () {
    f6(this, "EMBEDS_AD_EVENT_TYPE_AD_STARTED");
  };
  g.k.onAdComplete = function () {
    f6(this, "EMBEDS_AD_EVENT_TYPE_AD_COMPLETED");
  };
  g.k.onAdSkip = function () {
    f6(this, "EMBEDS_AD_EVENT_TYPE_AD_SKIPPED");
  };
  g.k.onAdStateChange = function (a) {
    2 === a && f6(this, "EMBEDS_AD_EVENT_TYPE_AD_PAUSED");
  };
  g.pV("embed", qtb);
})(_yt_player);
